...
config.landing_page_content = '<p class=\'centre\'>VKT Voter is a provided as a free service to the community by vankia. You can use it to monitor the votes of block producers and to vote</p>';

// Warning voting page content should include HTML tag it will be injected into a div tag
config.voting_page_content = '<p class=\'centre\'>You may vote for up to 30 block producer candidates. Or you can proxy your vote to another VKT user.</p>'

// Message to give this users when this chain activates
// Warning voting page content should include HTML tag it will be injected into a div tag
config.has_activated_message = '<p class=\'centre-activated\'>This particular VKT block chain has now reached the 15% activation threshold</p>'
...
<p>Ask the entity to update their producer name to match the name in the bp.json on their website or contact vankia for help.</p>
`
