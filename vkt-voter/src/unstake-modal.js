...
class UnstakeModal extends EosVoterModal {
    ...
    get_internal_content() {
        return [
                 m('h2', {'style': {'text-align': 'center'}}, 'Unstake your VKT'),
                 m('div', {'style': {'width': '100%', 'height': 'calc(100% - 120px - 49px)'}}, [
                   m('p', {'class': 'constitution-agreement-text', 'style': {'text-align': 'center', 'color': 'red'}}, [
                     ...
                     m('a', {'class': 'constitution-agreement-link',
                             'href': 'https://github.com/VKT-Mainnet/governance/blob/master/eosio.system/eosio.system-clause-constitution-rc.md',
                             'target': '_blank'},
                             'VKT Constitution detailed here'),
                   ]),
                   m('h2', {'style': {'text-align': 'center'}}, 'You must unstake VKT from CPU and Net to trade'),
                   ((this.delegated_cpu_weight == 0 && this.delegated_net_weight == 0) ? [
                     m('h2', {'style': {'text-align': 'center', 'color': 'red'}}, 'You currently have no staked VKT'),
                   ]:[]),
                   m("p", 'Your available VKT balance is ' + this.balance + ' VKT.'),
                   m("p", 'You currently have ' + this.delegated_cpu_weight + ' VKT staked to CPU.'),
                   m("p", 'You currently have ' + this.delegated_net_weight + ' VKT staked to Net.'),
                   m("p", 'Enter the number of VKT tokens you wish to remove from the stake and return to your account.'),
                   m('div', {'style': {'margin-bottom': '3px'}}, [
                     ...
                     m('span', {'style': {'margin-left': '3px'}}, 'VKT'),
                   ]),
                   m('div', {'style': {'margin-bottom': '3px'}}, [
                     m('div', {'style': {'width': '160px', 'display': 'inline-block'}}, [
                 ...
                 m('div', {'style': {'width': '100%', 'height': '120px'}}, [
                   m('div', {'style': {'text-align': 'center'}}, [
                     m("Button", {'class': 'big-vote-now-button', 'onclick': e => this.unstake_now()},
                       (this.is_staking == false ? "Unstake VKT" : [
